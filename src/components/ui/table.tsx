...
export const TH = (p: React.ThHTMLAttributes<HTMLTableCellElement>) => <th {...p} className={cn("h-10 px-2 text-left sm:px-3 align-middle text-xs font-medium uppercase tracking-wide text-muted-foreground", p.className)} />;
export const TD = (p: React.TdHTMLAttributes<HTMLTableCellElement>) => <td {...p} className={cn("px-2 py-2.5 align-middle sm:px-3", p.className)} />;
