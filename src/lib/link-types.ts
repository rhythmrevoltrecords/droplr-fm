...
export const LINK_TYPES: LinkType[] = [
  ...
  { key: "futuresave", name: "Future Save", description: "Fans follow once and every future release lands in their library.", status: "soon", artwork: "artist", preview: { a: "#6366F1", b: "#14B8A6", title: "OTOTO" } },
  ...
  { key: "action", name: "Action Page", description: "Unlock a download or exclusive after a follow, save or share.", status: "soon", artwork: "release", preview: { a: "#10B981", b: "#3B82F6", title: "Unlock" } },
