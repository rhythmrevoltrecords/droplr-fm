...
export const GUIDES: Guide[] = [
  ...
  {
    slug: "merch-that-sells",
    title: "Merch that actually sells",
    summary: "What to make first, what to charge, and why the table at your own show beats the online store for a long time.",
    tag: "Merch",
    minutes: 8,
    checked: "21 September 2026",
    inside: [
      "The first three items, and the one most artists waste money on",
      "Pricing that isn't a guess, with the numbers to work from",
      "Print-on-demand against a local screen printer",
      "Sizes, stock and the boxes in your hallway",
      "Selling it without sounding like an ad",
    ],
    public: [
      { p: "Merch is usually the first money an independent artist makes that isn't fractions of a cent. A shirt at a show clears more than tens of thousands of streams, and the person wearing it advertises you for two years. It is also where new artists lose money fastest, because the temptation is to order a lot of one thing before anyone has asked for it." },
      { h: "Work out who's actually buying before you print" },
      { ul: [
        "Look at where your listeners are and how old they are. A hoodie is a different product in Brisbane than in Manchester.",
        "Ask. A story poll costs nothing and is more reliable than your taste.",
        "Notice what your crowd already wears to your shows. That's your brief.",
      ] },
      { h: "Product, price, place, promotion" },
      { p: "The old marketing four still works because merch is a retail business wearing a band t-shirt. What to make, what to charge, where it's sold, and how anyone finds out. Most merch that fails has had thought put into the first and none into the other three." },
    ],
    member: [
      { h: "The first three things to make" },
      { ol: [
        "A t-shirt, in one good design. Not five designs in small quantities.",
        "Something cheap that isn't clothing: stickers, a pin, a tote. It catches the person who wants to support you but won't spend $45.",
        "Something physical and musical if it suits you: a CD, cassette or vinyl. Plenty of people buy these to hold them, not to play them.",
      ] },
      { note: "The classic waste is hoodies in six sizes before you know your crowd. They cost the most, take the most storage and sell the slowest." },
      { h: "Pricing without guessing" },
      { ul: [
        "Start from cost. Blank plus print plus shipping to you plus the packaging plus your time.",
        "Cost-plus: land on a margin you can live with, usually somewhere around double, and check it against what comparable artists charge locally.",
        "Perceived value: a limited run of 50, numbered, can carry a higher price than the same shirt with no story.",
        "Bundles work: shirt plus download plus sticker at a small discount moves more than three separate items, and lifts the average sale.",
        "Round numbers at a show. Nobody wants change at a merch table and neither do you.",
      ] },
      { h: "Where it gets made" },
      { ul: [
        "Print-on-demand: no upfront money, no boxes, thinner margin, and you don't control quality or the unboxing. Good for testing a design and for overseas fans.",
        "Local screen printer: better margin per unit, much better product, minimum order and money up front. Good once a design has proven itself.",
        "The usual path is print-on-demand to find out what sells, then a local run of the one that did.",
        "Order a sample of anything before you offer it to a fan. You cannot un-send a bad shirt.",
      ] },
      { h: "Sizes and stock" },
      { ul: [
        "Order the middle sizes heaviest. Roughly speaking most of a run goes in the middle of the range.",
        "Selling out is better than dead stock. A sold-out design is a reason to announce the next one.",
        "Count what you took and what you came home with after every show. That record is the only real data you'll get early on.",
      ] },
      { h: "Where you'll actually sell it" },
      { ul: [
        "The merch table at your own show, by a distance. Nowhere else has people who've just watched you and have cash in hand.",
        "Bandcamp if you want it beside the music and don't want to run a store.",
        "Your own store on a hosted platform once volume justifies it, linked from your droplr page and your bio link.",
        "Take card payments. The number of sales lost to \"I've only got card\" is higher than people think.",
      ] },
      { h: "Telling people, without sounding like an ad" },
      { ul: [
        "Show it being worn and used, not laid flat on a floor.",
        "Scarcity if it's true and never if it isn't: a run of 50, open for a week. Fake urgency gets noticed.",
        "Email the fans who ticked the news box. They opted in to hear from you, and they are the warmest list you have.",
        "Tie a drop to something: a release, a show, a milestone. A reason to buy now beats a reminder that a store exists.",
      ] },
      { note: "Your name and logo can be protected as trade marks in Australia through IP Australia. It isn't urgent on day one, but it's worth knowing before you put a lot of money into a brand someone else could register." },
    ],
    sources: [
      { label: "Berklee Online — Music Business Handbook (merchandise)", url: "https://online.berklee.edu/" },
      { label: "IP Australia — trade marks", url: "https://www.ipaustralia.gov.au/trade-marks" },
      { label: "Bandcamp — selling merch", url: "https://get.bandcamp.com/merch" },
    ],
  },
  {
    slug: "running-it-like-a-business",
    title: "Running it like a business (Australia)",
    summary: "Hobby or business, ABN, sole trader or company, the GST line, and what you can actually claim. The Australian version, because the American one will cost you.",
    tag: "Money",
    minutes: 9,
    checked: "21 September 2026",
    inside: [
      "The test the ATO actually applies to hobby versus business",
      "Why not having an ABN can cost you 47% of a payment",
      "Sole trader against a company, with the real numbers",
      "The $75,000 line and the 21 days you get",
      "What to keep, from the first gig",
    ],
    public: [
      { p: "Most music-business advice online is American, and on this subject it is worse than useless. LLCs, W9s, filing with the IRS and registering as your own publisher to take the publisher's share — none of that is how it works here. Doing the American version in Australia will cost you money and time." },
      { h: "Hobby or business" },
      { p: "There is no single moment when one becomes the other, and no income figure that decides it. The ATO looks at whether you intend to make a profit and could reasonably expect to, whether you're doing it repeatedly and in an organised way, and whether you've taken the formal steps: a registered business name, an ABN, separate records, a separate bank account." },
      { ul: [
        "A hobby doesn't declare the income and can't claim the expenses.",
        "A business declares all of it and can claim against it.",
        "You don't get to pick whichever suits you. The facts decide, and the ATO can rule on it if you ask.",
      ] },
      { note: "General information only, checked 21 September 2026, and not tax or financial advice. Thresholds and rates change. Check the ATO and business.gov.au pages linked at the end, and talk to an accountant about your own situation." },
    ],
    member: [
      { h: "Get an ABN early" },
      { ul: [
        "It's free, from the Australian Business Register, and you can hold one as a sole trader.",
        "Without one, a business paying you may be required to withhold 47% of the payment. Venues, labels and sync clients all deal with this constantly.",
        "It is the difference between invoicing a festival like a professional and being treated as a problem.",
      ] },
      { h: "Sole trader or company" },
      { table: {
        head: ["", "Sole trader", "Company"],
        rows: [
          ["Tax", "Your own income tax rates", "Flat 30% (lower for base rate entities)"],
          ["Tax-free threshold", "Yes — the first $18,200", "None. Tax on every dollar"],
          ["Liability", "You are the business. Personal assets exposed", "Separate legal entity"],
          ["Setup and upkeep", "Free ABN, minimal", "Registration fees, annual review, more admin"],
          ["Capital gains", "Discount method and small business concessions available", "Generally cannot use the discount method"],
        ],
        caption: "Checked 21 September 2026 against business.gov.au. Rates and thresholds change — verify before deciding.",
      } },
      { ul: [
        "Nearly every artist starts as a sole trader, and most stay there for years. It is cheap, simple, and the tax-free threshold matters when income is small.",
        "A company starts making sense with real money, real risk, or several people who need the thing to exist separately from them.",
        "A band splitting money is not automatically a partnership or a company. Write down who owns what before it matters — droplr's splits template exists for this.",
      ] },
      { h: "The GST line" },
      { ul: [
        "You must register for GST once your turnover hits $75,000 in a 12-month period, or once you expect it to in your first year. Non-profits have a higher threshold of $150,000.",
        "Once you're required to register you have 21 days to do it. Late registration attracts penalties and interest.",
        "Registered means adding GST to what you charge and claiming it back on what you buy. Under the threshold you can register voluntarily, which occasionally suits someone with big equipment purchases — that's an accountant conversation, not a blog one.",
      ] },
      { h: "What you can claim" },
      { p: "If it's genuinely for the business and you have the record, it's generally deductible. The failure mode is almost never what people claim — it's that they can't prove it a year later." },
      { ul: [
        "Instruments, recording gear, software subscriptions, plugins.",
        "Distribution fees, mastering, artwork, photography, video.",
        "Travel to gigs and sessions, and the kilometres if you drive.",
        "Marketing: ads, print, merch production.",
        "APRA AMCOS and PPCA membership, and your droplr subscription.",
        "The portion of your phone and internet that is actually work, not all of it.",
      ] },
      { h: "Records, from the first gig" },
      { ol: [
        "A separate bank account. This one change removes most of the pain at tax time.",
        "Every dollar in: gigs, streaming, merch, sync, grants. droplr and your distributor both export, and the expense ledger template covers the rest.",
        "Every receipt out, photographed the day you get it. The ATO app or any ledger app will do.",
        "Reconcile monthly. An hour a month beats a lost weekend in July.",
      ] },
      { h: "Grants are income too, and most artists never apply" },
      { ul: [
        "Grants are not repayable and are not charity. The funder has a mission and is looking for people who advance it — the application is a case for a shared aim, not a request for a favour.",
        "Work out first whether you're applying as an individual or an organisation, and whether you're asking for seed money or ongoing support. Most rejections are an application aimed at the wrong thing.",
        "Winning one makes the next one easier: funders read credibility off other funders.",
        "Creative Australia and APRA AMCOS both keep current lists. Rounds close on fixed dates — check the official pages, not a summary like this one.",
      ] },
      { h: "When an accountant stops being optional" },
      { ul: [
        "Once income is regular, once there's a second person's money involved, or once you're deciding between structures.",
        "Take them a year of clean records rather than a shoebox. The fee scales with the mess.",
        "One conversation early is usually cheaper than fixing two years of guesses.",
      ] },
    ],
    sources: [
      { label: "business.gov.au — business or hobby", url: "https://business.gov.au/planning/new-businesses/difference-between-a-business-and-a-hobby" },
      { label: "business.gov.au — sole trader vs company tax", url: "https://business.gov.au/planning/business-structures-and-types/business-structures/tax-differences-between-a-sole-trader-and-a-company" },
      ...
      { label: "Australian Business Register — apply for an ABN", url: "https://www.abr.gov.au/business-super-funds-charities/applying-abn" },
      { label: "APRA AMCOS — funding and grants", url: "https://www.apraamcos.com.au/music-creators/member-resources/funding-opportunities-grants" },
      { label: "Berklee Online — Music Business Handbook (business entity, grants)", url: "https://online.berklee.edu/" },
    ],
  },
  {
    slug: "is-it-finished",
    title: "Is it finished?",
    summary: "The checks that decide whether a track is ready to go to a distributor, and how to stop rewriting a song that was done three weeks ago.",
    tag: "Craft",
    minutes: 7,
    checked: "21 September 2026",
    inside: [
      "Four questions that catch most arrangement problems",
      "Why the pop timing rules don't apply to a club track",
      "The take with the feel beats the take that's correct",
      "Mix checks you can do without a studio",
      "Setting a date and actually stopping",
    ],
    public: [
      { p: "droplr can't tell you whether a song is good. What it can tell you is that most releases that go nowhere had something obvious wrong with them that another week would have fixed, and that roughly as many were rewritten to death long after they were finished. Both are the same problem: no one decided what finished meant." },
      { h: "Four questions" },
      { ul: [
        "Repetition: is there something that comes back often enough for a stranger to hold onto after one listen?",
        "Contrast: does anything actually change? A track with no shift in energy stops being heard about ninety seconds in.",
        "Arc: is there a peak, and does everything before it earn it?",
        "Meaning: does every production choice serve what the song is about, or are some of them there because you learned a new plugin?",
      ] },
      { p: "These come out of how records are taught to be produced, and they catch more problems than any amount of EQ." },
    ],
    member: [
      ...
      { h: "The take with the feel wins" },
      { ul: [
        "Pick vocal takes on emotion and phrasing, not accuracy. Timbre and delivery carry a song that technical perfection doesn't.",
        "Keep the mistake if it's doing something. Plenty of famous records have bleed, noise and flubs left in because removing them removed the feeling.",
        "Work with the performance you actually got rather than the one you imagined. Editing towards an idea that isn't in the recording is where weeks disappear.",
        "The producer's real job is partly psychological. A tense session produces tense takes, whether the producer is someone else or you.",
      ] },
      { h: "Mix checks without a studio" },
      { ul: [
        "Cut before you boost. Take out what's in the way before adding presence to what isn't.",
        "Reference against a commercial track in your genre, matched roughly for loudness. Your ears lie about level, not about balance.",
        "Check on three things: headphones, a phone speaker, and a car if you have one.",
        "Leave it a day and listen once, cold, without touching anything. The first thirty seconds of that listen tell you more than an afternoon of tweaking.",
        "If you're paying for mastering, send a mix with headroom and no limiter on the master. Ask what they want rather than guessing.",
      ] },
      { h: "Deciding it's done" },
      { ul: [
        "Set the release date before the track is finished, then work back. Producers have a saying for it: on time and on budget. A deadline is what turns a project into a record.",
        "Write down what finished means for this track before you start mixing. Three specific things, not a feeling.",
        "One more pass is almost always the one that makes it worse. If you can't name what's wrong, it's done.",
        "Volume beats perfection early on. People who write a hundred things get further than people who polish three, and the good ones are usually not the ones you expected.",
        "Once the date is in droplr, the promo plan counts back from it and the reminders start. That's the point: the date does the deciding so you don't have to keep making the call.",
      ] },
      { note: "None of this is a substitute for another set of ears. The cheapest improvement available to most artists is one honest person who isn't in the room while you make it." },
    ],
    sources: [
      { label: "Berklee Online — Music Production Handbook", url: "https://online.berklee.edu/" },
      { label: "Berklee Online — Songwriting Handbook", url: "https://online.berklee.edu/" },
      { label: "Berklee Online — Electronic Music Production & Sound Design Handbook", url: "https://online.berklee.edu/" },
    ],
  },
];
