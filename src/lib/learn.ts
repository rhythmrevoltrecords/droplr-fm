...
export const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    summary: "What the words in a record deal actually mean, what a manager is worth, and how to set the band up so a fallout doesn't take the name with it.",
    tag: "Business",
    minutes: 10,
    checked: "18 September 2026",
    inside: [
      ...
      "Band names, trademarks and setting up in Australia",
    ...
    member: [
      ...
      { h: "The band, as a business" },
      { ul: [
        "Get an ABN. It's free, it takes minutes, and without one APRA AMCOS withholds tax at the top rate above small thresholds.",
        "Two or more people sharing profits is effectively a partnership whether or not you write anything down, which also means shared liability. A written band agreement covering splits, name ownership, gear and what happens when someone leaves is worth more than any contract you'll sign with a label.",
        "A company (with an ACN) makes sense when there's real money, staff or risk. It costs money to run and needs proper accounting: talk to an accountant before incorporating.",
        "Keep the songwriting splits separate from the band split. Who wrote it and who's in the band are different questions, and money follows the first one.",
      ] },
      { h: "Your name" },
      { ul: [
        "Search before you commit: IP Australia's trade mark register, plus Spotify, Bandcamp and Instagram. Sharing a name with a bigger act is a permanent handicap on every search result.",
        ...
        "Write down who owns the name if the lineup changes. This is the single most common band argument that ends up with lawyers.",
      ] },
