    ...
    <LegalShell slug="privacy" toc={toc} contact="privacy">
      ...
      <Section {...s("collect")}>
        ...
        <ul>
          ...
          <li><strong>Release clips</strong>: nothing. The clip is made in your browser from a track you pick on your own computer, and neither the audio nor the finished video is ever sent to us. We don&apos;t record that you made one, how long it was or what was in it.</li>
