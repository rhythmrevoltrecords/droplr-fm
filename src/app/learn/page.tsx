  ...
  return (
    <MarketingShell>
      <div className="container max-w-4xl py-14">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Every guide opens here. The detailed version is inside droplr, on every plan including Free.</p>
        ...
        <div className="mt-10 rounded-2xl border border-violet-500/30 bg-violet-500/[0.07] p-6">
          ...
          <p className="mt-1 text-sm text-muted-foreground">A droplr account gets you the complete knowledge board, plus pre-save pages, a fan list and a promo plan for your releases.</p>
