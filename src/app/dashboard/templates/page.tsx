  ...
  return (
    <div className="max-w-4xl space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {TEMPLATES.map((t) => (
          <Link key={t.slug} href={`/dashboard/templates/${t.slug}`} className="group rounded-2xl border p-5 transition-colors hover:border-violet-400/40 hover:bg-white/[0.03]">
