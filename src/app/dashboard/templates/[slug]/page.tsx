  ...
  return (
    <div className="space-y-6">
      <div className="no-print max-w-3xl space-y-4">
        <p className="text-sm text-muted-foreground"><Link href="/dashboard/templates" className="hover:underline">Templates</Link> / {template.tag}</p>
        <div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Link href={`/dashboard/templates/${template.slug}${sample ? "" : "?sample=1"}`} className="text-sm text-muted-foreground underline hover:text-foreground">
