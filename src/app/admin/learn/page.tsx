...
export default function LearnHome() {
  return (
    <div className="max-w-4xl space-y-6">
      ...
      <GuideCards base="/admin/learn" />
      <p className="text-sm text-muted-foreground">Need the paperwork? <a href="/admin/templates" className="underline hover:text-foreground">Printable templates</a>: splits sheet, release metadata, release checklist, press one-pager, artist onboarding.</p>
