...
async function main() {
  ...
  const upcoming = await prisma.release.upsert({
    ...
    create: {
      ...
      upc: "000000000000",
      links: {
        create: [{ platform: "spotify", url: "https://open.spotify.com/album/0000000000000000000000", position: 0 }],
      },
  ...
  const live = await prisma.release.upsert({
    ...
    create: {
      ...
      links: {
        create: [
          { platform: "spotify", url: "https://open.spotify.com/album/1111111111111111111111", position: 0 },
          { platform: "appleMusic", url: "https://music.apple.com/au/album/example/1", position: 1 },
          { platform: "beatport", url: "https://www.beatport.com/release/example/1", position: 2 },
          { platform: "traxsource", url: "https://www.traxsource.com/title/1/example", position: 3 },
          { platform: "bandcamp", url: "https://rhythmrevoltrecords.bandcamp.com/album/example", position: 4 },
          { platform: "youtubeMusic", url: "https://music.youtube.com/playlist?list=example", position: 5 },
          { platform: "soundcloud", url: "https://soundcloud.com/ototo/example", position: 6 },
          { platform: "juno", url: "https://www.junodownload.com/products/example/1-02/", position: 7 },
          { platform: "deezer", url: "https://www.deezer.com/album/1", position: 8 },
